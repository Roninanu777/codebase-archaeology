...
claim cited to a commit or comment.

**Live demo:** https://codebase-archaeology.pages.dev · API/MCP: https://ronirajkamalpradhan1112--codebase-archaeology-web-fastapi-app.modal.run
(Explain and add-repo need the `X-Archaeology-Token`; Trace is open.) See [docs/DESIGN.md](docs/DESIGN.md) for architecture
